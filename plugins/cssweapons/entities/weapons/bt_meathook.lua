...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.065, 1.608, 5.269), angle = Angle(180, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.31, 1.082, -7.025), angle = Angle(0, 90, 0), size = Vector(0.791, 0.791, 0.791), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
