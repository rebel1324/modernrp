...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props_trainstation/TrackSign03.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0.21, -0.345, 3.607), angle = Angle(0, 0, 0), size = Vector(0.62, 0.62, 0.62), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_trainstation/TrackSign03.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.198, 0.606, -1.691), angle = Angle(180, -95.936, 0), size = Vector(0.62, 0.62, 0.62), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
