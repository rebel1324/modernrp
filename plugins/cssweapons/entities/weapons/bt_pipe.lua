...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props_canal/mattpipe.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0, 0, -3), angle = Angle(180, 100, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_canal/mattpipe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.49, 0.43, -0.883), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
